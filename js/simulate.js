...
function calculateSimulation() {
    ...
    const CONFIG = {
        eloDivisor: 700,        // Suaviza probabilidades para Elo 1500-2200+
        minProb: 0.13,          // Probabilidad mínima (15%)
        maxProb: 0.87,          // Probabilidad máxima (85%)
        simulations: 12000,     // Iteraciones Monte Carlo
        uncertainty: 50,        // Factor de incertidumbre
        margin: 1.05            // Margen de casa para cuotas
    };
